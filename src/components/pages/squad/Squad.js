									...
									<div className={cx("Squad_player")}>
										<div className={cx("player")}>
											<div className={cx("row")}>
												<div className={cx("d-flex")}>
													<div className={cx("avatar")}><img src={a.thumbnail} alt="" /></div>
													<div className={cx("right")}>
														<span>
															<strong className={cx("name")}>{a.name}</strong>
														</span>
														<span className={cx("nationality")}>
															<img src="/images/detail/brazil.png" alt="Argentina" className={cx("flag")} />{a.country}
														</span>
													</div>
												</div>
											</div>
										...
										<div className={cx("content")}>
											...
											<div className={cx("width_common")}>
												...
												<Link to={`/club/${item.name}/${item.id}`} className={cx("right")}><img src={item.thumbnail} className={cx("logo-club")} alt="" /></Link>
											</div>
