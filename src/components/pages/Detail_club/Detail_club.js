      ...
      <div className={cx("container")}>
        <div className={cx("desc_club row my-5")}>
          <div className={cx("desc_text mt-lg-0")}>
            ...
            {isTeam
              ? isTeam.description.map((item, index) => (
                  <p key={index}>- {item}</p>
                ))
              : "Dont Team"}
          </div>
        ...
        <div className={cx("honours")}>
          ...
          {isTeam
            ? isTeam.achievements.map((item, index) => (
                <p key={index} className={cx("list_honours")}>
                  - {item}
                </p>
              ))
            : "Dont Team"}
        ...
        <div className={cx("coach")}>
          ...
          <div className={cx("row")}>
            <div className={cx("col-lg-3 col-12 p-0 pt-3")}>
              <img
                src={coach ? coach.thumbnail : ""}
                className={cx("w-100 p-3 shadow")}
                alt=""
              />
            </div>
            <div className={cx("name_coach", "d-block col-lg-9 col-12")}>
              <h1 className={cx("d-block m-0 py-2 text-dark mb-2")}>
                {coach ? coach.name : ""}
              </h1>
              <h5 className={cx("text-secondary")}>
                <b className={cx("text-dark")}>Date of birth:</b>{" "}
                {coach ? coach.birthday : ""}
              </h5>
              <h5 className={cx("text-secondary")}>
                <b className={cx("text-dark")}>Place of birth:</b>{" "}
                {coach ? coach.country : ""}
              </h5>
              <h5 className={cx("text-secondary", "description")}>
                <b className={cx("text-dark")}>Description:</b>{" "}
        ...
        <div className={cx("list_players")}>
          <div className={cx("title_player")}>
            <h2 className={cx("tieu_de", "text-center text-danger")}>
              PLAYERS
            </h2>
          </div>
